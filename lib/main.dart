...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildSeriesList() =>
      ListView(
        children: [
          _title('Star Trek: Picard', DateTime.parse("2020-01-23"),
              "assets/images/icons/picard.jpg"),
          _title('The New Pope', DateTime.parse("2020-01-23"),
              "assets/images/icons/theNewPope.jpg"),
          _title('Westworld', DateTime.parse("2016-10-02"),
